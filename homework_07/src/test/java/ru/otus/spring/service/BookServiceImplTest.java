...
class BookServiceImplTest {
    ...
    @BeforeEach
    void init(){
        given(bookRepository.isExistsById(EXISTING_BOOK_ID)).willReturn(true);
    }
    ...
    void shouldSuccessfullyInsertBook(){
        ...
        given(authorRepository.findById(EXISTING_AUTHOR_ID)).willReturn(getExpectedAuthor());
        given(genreRepository.findById(EXISTING_GENRE_ID)).willReturn(getExpectedGenre());
    ...
    void shouldUpdateBook(){
        ...
        given(bookRepository.findById(EXISTING_BOOK_ID)).willReturn(existingBook);
